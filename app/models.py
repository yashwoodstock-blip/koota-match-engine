...
class MatchResult(Base):
    ...
    score_uncertainty = Column(Float, nullable=True)
    score_interval = Column(JSON, default=list, nullable=True)
    confidence = Column(String(50), nullable=True)
    evidence_coverage_pct = Column(Float, nullable=True)
    critical_contradictions = Column(Integer, default=0, nullable=True)
    high_impact_uncertainty = Column(JSON, default=list, nullable=True)
